...
function problemTwo(){
    let userChoice = prompt("Enter a cuisine ")
    cuisine = dishes.filter(function(dish){
        if (dish.cuisine === userChoice){
            return true;
        }  
        else{
            return false;
...
// console.log('user has chosen ', userCuisine)
...
function problemSix(){
    let results;
    results = dishes.includes("chickpea");{
        if (results.ingredients = "chickpea"){
            return true;
        }
        else{
            return false;
...
// cuisineList = problemEight();
// console.log(problemEight(dishes))
...
// specificCuisine = problemNine();
// console.log(specificCuisine)
